...
public class MainTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        c.getAccountQueue().addAccount(new LeagueAccount(LeagueServer.NORTH_AMERICA, "4.3.xx", "yerichtest1", args[0]));
        final String SUMMONER_TO_LOOK_UP = "NotKing Xj9";
                ...
                c.getGameService().fillActiveGameData(summoner, new Callback<LeagueSummoner>() {
                    public void onCompletion(LeagueSummoner summoner) {
                        ...
                        if(summoner.getActiveGame() != null) {
						    ...
						    System.out.println(game.getObserverCredentials().getEncryptionKey());
                        } else {
